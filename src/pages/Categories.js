            ...
            <div className="container">
              ...
              <div className="package-section">
                ...
                <article className="package-item">
                  ...
                  <div className="package-price">
                    <div className="review-area">
                      <span className="review-text">(12 reviews)</span>
                      <div className="rating-start-wrap d-inline-block">
                        <div className="rating-start">
                          <span style={{ width: "80%" }} />
                        </div>
                ...
                <article className="package-item">
                  <figure
                    className="package-image"
                    style={{ backgroundImage: "url(assets/images/img6.jpg)" }}
                  />
                  <div className="package-content">
                    <h3>
                      <a href="package-detail.html">
                  ...
                  <div className="package-price">
                    <div className="review-area">
                      <span className="review-text">(43 reviews)</span>
                      <div className="rating-start-wrap d-inline-block">
                        <div className="rating-start">
                          <span style={{ width: "80%" }} />
                        </div>
              ...
              <div className="gallery-section">
                <div className="gallery-container grid">
                  ...
                  <div className="single-gallery grid-item">
                    <figure className="gallery-img">
                      <a
                        href="assets/images/img13jpg.html"
            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-md-4 text-md-end">
                  ...
                  <Link className="outline-btn outline-btn-white" to='/contact-us'>Contact Us!</Link>
                </div>
              </div>
            </div>
          </section>
